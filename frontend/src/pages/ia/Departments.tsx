  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-[#1E1B4B] dark:text-indigo-50 tracking-tight">Department Management</h1>
          <p className="text-sm text-[#4C1D95]/60 dark:text-indigo-200/60 mt-1">
            Create departments and assign Head of Departments (HODs).
          </p>
        </div>
      ...
      <div className="p-8 bg-white dark:bg-[#110A24] border border-[#7C3AED]/10 dark:border-violet-500/20 rounded-3xl shadow-sm">
        <div className="flex flex-col items-center justify-center py-16 text-[#4C1D95]/30 dark:text-indigo-200/30">
          ...
          <p className="text-sm font-bold mt-4">No departments found. Set up your institution's departments to assign tasks.</p>
        </div>
      </div>
    </div>
  );

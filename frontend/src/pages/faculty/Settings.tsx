        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-8 shadow-xl shadow-[#7C3AED]/5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-6 opacity-[0.03] group-hover:opacity-[0.06] transition-opacity">
              <User className="w-32 h-32 text-[#7C3AED]" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm font-bold text-[#1E184B]/50 mb-6">{JSON.parse(localStorage.getItem('user') || '{}').email}</p>
              
              <div className="space-y-4 pt-6 border-t border-slate-100">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Monthly Goal</span>
                  <span className="text-[10px] font-black text-[#7C3AED]">{currentPoints} / {settings.merit_goal} pts</span>
                </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    settings.availability_status === status 
                      ? "bg-white text-[#1E184B] border-white shadow-xl shadow-white/10" 
              ...
              >
                <div className="bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-10 shadow-xl shadow-[#7C3AED]/5">
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-[#1E184B]">Academic Profile</h3>
                      <p className="text-sm font-bold text-[#1E184B]/40">Manage your expertise and availability.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-2">
                        <label className="text-[10px] font-black text-[#1E184B] uppercase tracking-widest ml-1">Expertise Tags</label>
                        <div className="relative">
                          <Hash className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#7C3AED]" />
                          <input 
                            type="text"
                            ...
                            className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold focus:bg-white focus:border-[#7C3AED] focus:ring-4 focus:ring-[#7C3AED]/5 transition-all outline-none"
                          />
                        </div>
                      </div>

                      <div className="space-y-2">
                        <label className="text-[10px] font-black text-[#1E184B] uppercase tracking-widest ml-1">Office Hours</label>
                        <div className="relative">
                          <Clock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#7C3AED]" />
                          <input 
                            type="text"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between px-1">
                        <label className="text-[10px] font-black text-[#1E184B] uppercase tracking-widest">Monthly Merit Goal</label>
                        <span className="text-sm font-black text-[#7C3AED] bg-[#7C3AED]/5 px-4 py-1.5 rounded-full border border-[#7C3AED]/10">{settings.merit_goal} Points</span>
                      </div>
                      <input 
                        type="range"
                        min="10"
                        ...
                        className="w-full h-2 bg-slate-100 rounded-full appearance-none cursor-pointer accent-[#7C3AED]"
                      />
              ...
              >
                <div className="bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-10 shadow-xl shadow-[#7C3AED]/5">
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-[#1E184B]">Alert Preferences</h3>
                      <p className="text-sm font-bold text-[#1E184B]/40">Configure how and when you stay updated.</p>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-10 shadow-xl shadow-[#7C3AED]/5">
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-[#1E184B]">Security Suite</h3>
                      <p className="text-sm font-bold text-[#1E184B]/40">Manage your access and active sessions.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-[#1E184B]/40">Manage devices currently logged into your portal.</p>
                      </div>
                    </div>
                    {sessions.length > 1 && (
                      <button 

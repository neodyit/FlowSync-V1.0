  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-20">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-[#1E184B] tracking-tight">
          Hall of <span className="text-[#7C3AED]">Excellence</span>
        </h1>
        <p className="text-[#1E184B]/60 max-w-2xl mx-auto font-bold text-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-end gap-6 pt-10 px-4">
        ...
        {top3[1] && (
          <motion.div 
            ...
            className="order-2 md:order-1 bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-8 text-center space-y-6 relative group hover:shadow-2xl hover:shadow-[#7C3AED]/10 transition-all"
          >
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-slate-100 rounded-2xl flex items-center justify-center border-4 border-white text-slate-500 font-black">2</div>
            <div className="w-20 h-20 bg-slate-100 rounded-[1.5rem] overflow-hidden flex items-center justify-center mx-auto text-2xl font-black text-slate-400">
              {top3[1].profile_pic ? (
            ...
            <div>
              <Link to={`/faculty/profile/${top3[1].id}`} className="font-black text-[#1E184B] text-lg truncate hover:text-[#7C3AED] transition-colors block">
                {top3[1].name}
              </Link>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">{top3[1].dept_name}</p>
            </div>
            <div className="pt-4 border-t border-slate-50">
              <p className="text-2xl font-black text-[#1E184B]">{top3[1].total_score}</p>
        ...
        {top3[0] && (
          <motion.div 
            ...
            className="order-1 md:order-2 bg-[#1E184B] rounded-[3rem] p-10 text-center space-y-8 relative shadow-2xl shadow-[#1E184B]/20 transform md:-translate-y-6"
          >
            ...
            <div className="bg-white/10 rounded-[2rem] p-6 border border-white/10 backdrop-blur-md">
        ...
        {top3[2] && (
          <motion.div 
            ...
            className="order-3 md:order-3 bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-8 text-center space-y-6 relative group hover:shadow-2xl hover:shadow-[#7C3AED]/10 transition-all"
          >
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-amber-50 rounded-2xl flex items-center justify-center border-4 border-white text-amber-600 font-black">3</div>
            <div className="w-20 h-20 bg-amber-50 rounded-[1.5rem] overflow-hidden flex items-center justify-center mx-auto text-2xl font-black text-amber-400">
              {top3[2].profile_pic ? (
            ...
            <div>
              <Link to={`/faculty/profile/${top3[2].id}`} className="font-black text-[#1E184B] text-lg truncate hover:text-[#7C3AED] transition-colors block">
                {top3[2].name}
              </Link>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">{top3[2].dept_name}</p>
            </div>
            <div className="pt-4 border-t border-slate-50">
              <p className="text-2xl font-black text-[#1E184B]">{top3[2].total_score}</p>
              <p className="text-[9px] font-black text-[#7C3AED] uppercase tracking-widest">Skill Points</p>
            </div>
          </motion.div>
        )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8 space-y-4">
          <div className="flex items-center justify-between px-6 mb-6">
            <h2 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Top 10 Performers</h2>
          ...
          <div className="space-y-3">
            {others.map((performer, idx) => (
              <motion.div
                ...
                key={performer.id}
                className="bg-white rounded-3xl border border-[#7C3AED]/5 p-5 flex items-center gap-6 hover:border-[#7C3AED]/20 hover:shadow-xl hover:shadow-[#7C3AED]/5 transition-all group"
              >
                <div className="w-12 h-12 rounded-2xl bg-slate-50 overflow-hidden flex items-center justify-center text-[#1E184B] font-black text-sm group-hover:bg-[#7C3AED] group-hover:text-white transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <Link to={`/faculty/profile/${performer.id}`} className="font-black text-[#1E184B] group-hover:text-[#7C3AED] transition-colors truncate block">
                    {performer.name}
                  </Link>
                ...
                <div className="text-right">
                  <p className="text-xl font-black text-[#1E184B]">{performer.total_score}</p>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-[#7C3AED] rounded-[2.5rem] p-10 text-white space-y-8 relative overflow-hidden shadow-2xl shadow-[#7C3AED]/20">
          ...
          <div className="bg-white rounded-[2.5rem] border border-[#7C3AED]/10 p-8 space-y-6">
            <h3 className="text-[10px] font-black text-[#1E184B]/40 uppercase tracking-[0.2em]">Leadership Metrics</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                <div className="flex items-center gap-3">
                  <Star className="w-4 h-4 text-amber-500" />
                  <span className="text-xs font-bold text-[#1E184B]">Peak Performance</span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-[#1E184B]">Growth Velocity</span>
                </div>

  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {deptRankings.slice(0, 3).map((dept, idx) => (
          <motion.div
            ...
            key={dept.id}
            className={cn(
              "p-8 rounded-[2.5rem] border relative overflow-hidden group transition-all",
              dept.id === myDeptId 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50 border-b border-[#7C3AED]/5">
                    ...
                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Missions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#7C3AED]/5">
                  {deptRankings.map((dept, idx) => (
                    <tr key={dept.id} className={cn(
                      ...
                      <td className="px-8 py-6">
                        <div>
                          <p className="font-black text-[#1E184B] group-hover:text-[#7C3AED] transition-colors">{dept.dept_name}</p>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <span className="text-[10px] font-black text-[#7C3AED] uppercase tracking-widest">Top 20</span>
          </div>
          <div className="space-y-3">
            {facultyList.map((performer, idx) => (
              <motion.div

-- Combined FlowSync Database Installation Script
-- Baseline: empty_db.sql (Up to Migration 27) + 00_seed.sql + Incremental Migrations 28-34

/********************************************************
 * BASELINE SCHEMA (empty_db.sql)
 ********************************************************/
...
/********************************************************
 * BASE SEEDS (00_seed.sql)
 ********************************************************/

INSERT INTO colleges (name, short_name) VALUES ('Neody IT', 'NIT');
INSERT INTO roles (name) VALUES ('Admin'), ('HOD'), ('Faculty');
INSERT INTO users (college_id, role_id, name, email, password_hash) 
VALUES (1, 1, 'Mayank Tiwari', 'mayank@neodyit.in', '$2y$10$bpki/jrROvD7NOI5XI/I7OukvIE21XQrD5dJjdjV5XSWqH2TnS8Q2');


/********************************************************
 * INCREMENTAL MIGRATION: 28_add_institution_admin_role.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 29_alter_departments_add_code_description.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 30_add_ia_task_management_feature.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 31_add_ia_activity_center_feature.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 32_subscription_system.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 33_advanced_subscription_features.sql
 ********************************************************/
...
/********************************************************
 * INCREMENTAL MIGRATION: 34_add_profile_completion_features.sql
 ********************************************************/
